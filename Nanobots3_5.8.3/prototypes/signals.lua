...
local signal1 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/chop-trees.png',
    icon_size = 64,
...
local signal2 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/item-on-ground.png',
    icon_size = 64,
    subgroup = 'nanobot-signals',
    order = '[nano-signal]-b'
}
...
--[[local signal3 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/remove-tiles.png',
    icon_size = 64,
    subgroup = 'nanobot-signals',
    order = '[nano-signal]-c'
}]]
...
local signal5 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/deconstruct-miners.png',
    icon_size = 64,
    subgroup = 'nanobot-signals',
    order = '[nano-signal]-e'
}
local signal6 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/remove-fish.png',
    icon_size = 64,
    subgroup = 'nanobot-signals',
    order = '[nano-signal]-f'
}
local signal99 = {
    ...
    icon = '__Nanobots3__/graphics/icons/signals/closest-roboport.png',
    icon_size = 64,
    subgroup = 'nanobot-signals',
    order = '[nano-signal]-z'
}
