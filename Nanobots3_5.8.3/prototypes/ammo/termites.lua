...
-- Was light green; now yellow/amber
local yellow = { r = 1.0, g = 1.0, b = 0.0, a = 0.35 }
...
local termites = {
    type = 'ammo',
    name = 'ammo-nano-termites',
    icon = '__Nanobots3__/graphics/icons/nano-ammo-termites.png',
    icon_size = 64,
    magazine_size = 20,
    subgroup = 'tool',
            ...
            source_effects = {
                {
                    type = 'play-sound',
                    sound = {
                        filename = '__Nanobots3__/sounds/robostep.ogg',
                        volume = 0.75
                    }
                }
            }
                        ...
                        action_delivery = {
                            ...
                            target_effects = {
                                ...
                                },
                                {
                                    ...
                                    sound = {
                                        filename = '__Nanobots3__/sounds/sawing-wood.ogg',
                                        volume = 0.15,
