...
-- Repair visual (green)
local repair_green = { r = 0.25, g = 1.0, b = 0.25, a = 0.35 }         -- cloud color (with alpha)
local repair_green_light = { r = 0.35, g = 1.0, b = 0.35, a = 1.0 }     -- projectile light color
...
local constructors = {
    type = 'ammo',
    name = 'ammo-nano-constructors',
    icon = '__Nanobots3__/graphics/icons/nano-ammo-constructors.png',
    icon_size = 64,
    magazine_size = 10,
    subgroup = 'tool',
...
-------------------------------------------------------------------------------
-- Projectile for repairs: shoots from player to target, releases a repair cloud.
local projectile_repair = {
    ...
    direction_only = false,
    animation = constants.projectile_animation,
    -- Optional green light glow (especially visible at night)
    light = { intensity = 0.7, size = 6, color = repair_green_light },
    final_action = {
        type = 'direct',
        action_delivery = {
            type = 'instant',
...
-- Repair cloud (VISUAL ONLY). Actual repair is handled by control scripts.
